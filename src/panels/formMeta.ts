...
export const STYLE_FIELDS: { key: AllowedStyleKey; label: string; control: FieldMeta['control']; group: FieldMeta['group']; options?: FieldMeta['options'] }[] = [
  ...
  { key: 'position', label: 'position', control: 'select', group: 'layout', options: ['static', 'relative', 'absolute', 'fixed', 'sticky'].map((v) => ({ label: v, value: v })) },
  { key: 'left', label: 'left', control: 'text', group: 'layout' },
  { key: 'top', label: 'top', control: 'text', group: 'layout' },
  { key: 'right', label: 'right', control: 'text', group: 'layout' },
  { key: 'bottom', label: 'bottom', control: 'text', group: 'layout' },
  { key: 'zIndex', label: 'z-index', control: 'text', group: 'layout' },
